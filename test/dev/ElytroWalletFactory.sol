 ...
 */
contract ElytroWalletFactory is Ownable {
     ...
     * @dev Used by elytrowalletlib to calculate the ElytroWallet address
    ...
    function _proxyCode() private pure returns (bytes memory) {
        return type(ElytroWalletProxy).creationCode;
    }
